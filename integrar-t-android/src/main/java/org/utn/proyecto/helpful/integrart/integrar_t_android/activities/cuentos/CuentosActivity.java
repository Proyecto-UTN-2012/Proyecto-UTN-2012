...
public class CuentosActivity extends RoboActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("oncreate cuentos", "estoy en el onCreateCuentos");
		...
		azarBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				startCuento(1 + (new Random()).nextInt(2));
			}
		});

	} // termino el oncreate

	public void startCuento(int cuen) {

		
	   Intent intent = new Intent(this, CurrentCuentoActivity.class);
	
		intent.putExtra("cuento", cuen);
		
	//	intent.putExtra("pagina",R.string.pinocho_pag1);
